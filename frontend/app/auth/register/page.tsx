...
import { UserRegister, ValidationError, ValidationResult } from '../../../types';
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div className="mb-4">
              ...
              <input
                ...
                className={`appearance-none rounded-none relative block w-full px-3 py-2 border ${
                  errors.some(e => e.field === 'firstName') ? 'border-red-300' : 'border-gray-300'
              ...
              {errors.some(e => e.field === 'firstName') && (
                <p className="mt-1 text-sm text-red-600">{errors.find(e => e.field === 'firstName')?.message}</p>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                required={false}
                className={`appearance-none rounded-none relative block w-full px-3 py-2 border ${
                  errors.some(e => e.field === 'lastName') ? 'border-red-300' : 'border-gray-300'
              ...
              {errors.some(e => e.field === 'lastName') && (
                <p className="mt-1 text-sm text-red-600">{errors.find(e => e.field === 'lastName')?.message}</p>
              )}
            </div>
